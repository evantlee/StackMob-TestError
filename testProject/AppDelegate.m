...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.client = [[SMClient alloc] initWithAPIVersion:@"0" publicKey:@"INSERT API KEY"];
    self.coreDataStore = [self.client coreDataStoreWithManagedObjectModel:self.managedObjectModel];
    self.coreDataStore.cachePolicy = SMCachePolicyTryNetworkElseCache;
    _window.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"appBG.png"]];
    return YES;
}
